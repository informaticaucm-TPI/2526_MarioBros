...
code that parses this format orchestrated by the `GameObjectFactory` class. We divide
the task of implementing the `load` command into the following subtasks:
